...
print(my_module.hello_world("John"))   # Вызовите функцию hello_world из модуля my_module
...
hello_world
print(hello_world('даниил'))
# Функция hello_world должна вызываться без указания модуля